...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("D:\\spaceworks\\20200621\\online_edu_parent\\online_edu_order\\src\\main\\java");
        globalConfig.setAuthor("huluo");
        //生成后是否打开资源管理器
        ...
        strategy.setInclude("edu_pay_log","edu_order");
